<template>
    <div id="app" v-cloak>
        ...
        <div class="centered-container">
            ...
            <md-content class="md-elevation-3" v-if="mode === 'query'">
                <div class="view-switch">
                    <md-button class="md-icon-button" @click="nextView">
                ...
                <div class="title">
                    <div class="logo"></div>
                    <div class="md-title">Pull Request Quality</div>
                    <div class="md-body-1">Validate commit messages</div>
                </div>

                <div class="form">
                    <md-field>
                        <label>Author</label>
                        <md-input v-model.trim="author" autofocus></md-input>
                    </md-field>
                    <md-checkbox v-model="onlyPullRequests">Only active Pull Requests</md-checkbox>
                </div>
                ...
                <div class="actions md-layout md-alignment-center-center">
                    <md-button
                        ...
                        @click="scanCommits">Scan</md-button>
                </div>
            ...
            <md-content class="md-elevation-3 w-wide" v-if="mode === 'results'">
                <div class="view-switch">
                    <md-button class="md-icon-button" @click="nextView">
                        <md-icon>chevron_right</md-icon>
                    </md-button>
                ...
                <div class="title">
                    <div class="md-title">Found {{ 1 }} Pull Requests</div>
                </div>
                <md-list>
                    <md-list-item md-expand>
                        <md-chip md-static>{{ matchedAuthors.length }}</md-chip>
                        <span class="md-list-item-text">Matching identities</span>

                        <md-list slot="md-expand">
                            <md-list-item v-for="a in matchedAuthors" :key="a">
...
7a4e92f Initial empt<span class="overflow">y commit</span></pre>
            ...
            <md-content class="md-elevation-3 w-medium" v-if="mode === 'no-results'">
                <div class="view-switch">
                    <md-button class="md-icon-button" @click="nextView">
                        <md-icon>chevron_right</md-icon>
                    </md-button>
                ...
                <div class="title">
                    <md-empty-state
                        ...
                        md-icon="search"
                        md-label="No results"
                        md-description="Pull Requests not found">
                    </md-empty-state>
                </div>
...
const MODES = { query: 0, results: 1, 'no-results': 2 };
const modeKey = (index) => Object.entries(MODES)[index][0];
...
export default {
  ...
  data() {
    return {
      ...
      mode: modeKey(localStorage.lastMode || MODES.query),
      ...
      pullRequests: [
          { id: 12345,
            commits: [
              { id: 12345, hash: '54321', message: '', author: '', date: '', },
            ],
            // calculated properties
            warnings: [ {msg:'3 of 7 commit messages slightly exceed 70 characters', rule: 1} ],
            errors: [ {msg:'1 of 7 commit messages significantly exceed 70 characters limit', rule: 1} ]
          }
        ]
    };
  },
  methods: {
    ...
    nextView() {
      this.loading = true;
      setTimeout(() => {
        const nextMode = (MODES[this.mode] + 1) % Object.keys(MODES).length;
        this.mode = modeKey(nextMode),
        localStorage.lastMode = nextMode;
        this.loading = false;
      }, 500);
    }
  },
...
.centered-container {
  ...
  .title {
    ...
    .logo {
      ...
      width: 80px;
      height: 80px;
      background: url(https://www.marketintelligencenetwork.com/img/ihsmarkit_logo.png);
  ...
  .md-content {
    ...
    &.w-medium { max-width: 700px }
    &.w-wide { max-width: 1000px }
  }
  .md-chip {
    margin-right: 1em;
  }
